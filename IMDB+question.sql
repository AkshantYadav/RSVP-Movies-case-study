...
-- Table director_mapping has 3867 rows

SELECT count(*)
FROM genre;
-- Table genre has 14662 rows

SELECT count(*)
FROM movie;
-- Table movie has 7997 rows

SELECT count(*)
FROM names;
-- Table names has 25735 rows

SELECT count(*)
FROM ratings;
-- Table ratings has 7997 rows

SELECT count(*)
FROM role_mapping;
-- Table role_mapping has 15615 rows
...
FROM   movie; 
-- The following columns in movie dataset has null values
-- country = 20
-- world_wide_gross_income = 3724
-- languages = 194
...
-- Top 3 movies are drama, comedy and action 
...
-- There are 361 movies with median rating of 8 released between 1st april 2018 to 1st april 2019
...
-- Yes, German movies gets more votes than Italian movies
